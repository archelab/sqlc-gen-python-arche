...
class GetEmbeddedTestPostgresTypeRow:
    ...
    Attributes:
        ...
        money_test: str
        bool_test: bool
        json_test: typing.Any
        jsonb_test: typing.Any
        bytea_test: bytes
...
async def create_one_test_postgres_inner_type(conn: ConnectionLike, *, table_id: int, serial_test: int | None, serial4_test: int | None, bigserial_test: int | None, smallserial_test: int | None, int_test: int | None, bigint_test: int | None, smallint_test: int | None, float_test: float | None, double_precision_test: float | None, real_test: float | None, numeric_test: decimal.Decimal | None, money_test: str | None, bool_test: bool | None, json_test: typing.Any | None, jsonb_test: typing.Any | None, bytea_test: bytes | None, date_test: datetime.date | None, time_test: datetime.time | None, timetz_test: datetime.time | None, timestamp_test: datetime.datetime | None, timestamptz_test: datetime.datetime | None, interval_test: datetime.timedelta | None, text_test: str | None, varchar_test: str | None, bpchar_test: str | None, char_test: str | None, citext_test: str | None, uuid_test: uuid.UUID | None, inet_test: str | None, cidr_test: str | None, macaddr_test: str | None, macaddr8_test: str | None, ltree_test: str | None, lquery_test: str | None, ltxtquery_test: str | None) -> None:
    ...
    Args:
        ...
        money_test: str | None.
        bool_test: bool | None.
        json_test: typing.Any | None.
        jsonb_test: typing.Any | None.
        bytea_test: bytes | None.
...
async def create_one_test_postgres_type(conn: ConnectionLike, *, id_: int, serial_test: int, serial4_test: int, bigserial_test: int, smallserial_test: int, int_test: int, bigint_test: int, smallint_test: int, float_test: float, double_precision_test: float, real_test: float, numeric_test: decimal.Decimal, money_test: str, bool_test: bool, json_test: typing.Any, jsonb_test: typing.Any, bytea_test: bytes, date_test: datetime.date, time_test: datetime.time, timetz_test: datetime.time, timestamp_test: datetime.datetime, timestamptz_test: datetime.datetime, interval_test: datetime.timedelta, text_test: str, varchar_test: str, bpchar_test: str, char_test: str, citext_test: str, uuid_test: uuid.UUID, inet_test: str, cidr_test: str, macaddr_test: str, macaddr8_test: str, ltree_test: str, lquery_test: str, ltxtquery_test: str) -> None:
...
async def create_result_one_test_postgres_type(conn: ConnectionLike, *, id_: int, serial_test: int, serial4_test: int, bigserial_test: int, smallserial_test: int, int_test: int, bigint_test: int, smallint_test: int, float_test: float, double_precision_test: float, real_test: float, numeric_test: decimal.Decimal, money_test: str, bool_test: bool, json_test: typing.Any, jsonb_test: typing.Any, bytea_test: bytes, date_test: datetime.date, time_test: datetime.time, timetz_test: datetime.time, timestamp_test: datetime.datetime, timestamptz_test: datetime.datetime, interval_test: datetime.timedelta, text_test: str, varchar_test: str, bpchar_test: str, char_test: str, citext_test: str, uuid_test: uuid.UUID, inet_test: str, cidr_test: str, macaddr_test: str, macaddr8_test: str, ltree_test: str, lquery_test: str, ltxtquery_test: str) -> str:
    ...
    Returns:
        The result of type `str` returned when executing the query.
    """
...
async def create_rows_one_test_postgres_type(conn: ConnectionLike, *, id_: int, serial_test: int, serial4_test: int, bigserial_test: int, smallserial_test: int, int_test: int, bigint_test: int, smallint_test: int, float_test: float, double_precision_test: float, real_test: float, numeric_test: decimal.Decimal, money_test: str, bool_test: bool, json_test: typing.Any, jsonb_test: typing.Any, bytea_test: bytes, date_test: datetime.date, time_test: datetime.time, timetz_test: datetime.time, timestamp_test: datetime.datetime, timestamptz_test: datetime.datetime, interval_test: datetime.timedelta, text_test: str, varchar_test: str, bpchar_test: str, char_test: str, citext_test: str, uuid_test: uuid.UUID, inet_test: str, cidr_test: str, macaddr_test: str, macaddr8_test: str, ltree_test: str, lquery_test: str, ltxtquery_test: str) -> int:
    ...
    """
    r = await conn.execute(CREATE_ROWS_ONE_TEST_POSTGRES_TYPE, id_, serial_test, serial4_test, bigserial_test, smallserial_test, int_test, bigint_test, smallint_test, float_test, double_precision_test, real_test, numeric_test, money_test, bool_test, json_test, jsonb_test, bytea_test, date_test, time_test, timetz_test, timestamp_test, timestamptz_test, interval_test, text_test, varchar_test, bpchar_test, char_test, citext_test, uuid_test, inet_test, cidr_test, macaddr_test, macaddr8_test, ltree_test, lquery_test, ltxtquery_test)
...
async def create_rows_table(conn: ConnectionLike) -> int:
    ...
    Returns:
        The number (`int`) of affected rows. This will be 0 for queries like `CREATE TABLE`.
    """
    r = await conn.execute(CREATE_ROWS_TABLE)
    return int(n) if (p := r.split()) and (n := p[-1]).isdigit() else 0
...
async def delete_one_rows_test_postgres_type(conn: ConnectionLike, *, id_: int) -> int:
    ...
    Returns:
        The number (`int`) of affected rows. This will be 0 for queries like `CREATE TABLE`.
    """
    r = await conn.execute(DELETE_ONE_ROWS_TEST_POSTGRES_TYPE, id_)
    return int(n) if (p := r.split()) and (n := p[-1]).isdigit() else 0
...
async def get_embedded_test_postgres_type(conn: ConnectionLike, *, id_: int) -> GetEmbeddedTestPostgresTypeRow | None:
    ...
    Returns:
        Result of type `GetEmbeddedTestPostgresTypeRow` fetched from the db. Will be `None` if not found.
    """
    row = await conn.fetchrow(GET_EMBEDDED_TEST_POSTGRES_TYPE, id_)
    if row is None:
        return None
...
def get_many_test_bytea_postgres_type(conn: ConnectionLike, *, id_: int) -> QueryResults[bytes]:
    ...
    Returns:
        Helper class of type `QueryResults[bytes]` that allows both iteration and normal fetching of data from the db.
    """
    def _decode_hook(row: asyncpg.Record) -> bytes:
        return bytes(row[0])
    return QueryResults[bytes](conn, GET_MANY_TEST_BYTEA_POSTGRES_TYPE, _decode_hook, id_)
...
def get_many_test_iterator_postgres_type(conn: ConnectionLike, *, id_: int) -> QueryResults[models.TestPostgresType]:
    ...
    Returns:
        Helper class of type `QueryResults[models.TestPostgresType]` that allows both iteration and normal fetching of data from the db.
    """
...
async def get_one_test_bytea_postgres_type(conn: ConnectionLike, *, id_: int) -> bytes | None:
    ...
    Returns:
        Result of type `bytes` fetched from the db. Will be `None` if not found.
    """
    row = await conn.fetchrow(GET_ONE_TEST_BYTEA_POSTGRES_TYPE, id_)
    if row is None:
        return None
    return bytes(row[0])
...
async def get_one_test_postgres_type(conn: ConnectionLike, *, id_: int) -> models.TestPostgresType | None:
    ...
    Returns:
        Result of type `models.TestPostgresType` fetched from the db. Will be `None` if not found.
    """
    row = await conn.fetchrow(GET_ONE_TEST_POSTGRES_TYPE, id_)
    if row is None:
        return None
    return models.TestPostgresType(id=row[0], serial_test=row[1], serial4_test=row[2], bigserial_test=row[3], smallserial_test=row[4], int_test=row[5], bigint_test=row[6], smallint_test=row[7], float_test=row[8], double_precision_test=row[9], real_test=row[10], numeric_test=row[11], money_test=row[12], bool_test=row[13], json_test=row[14], jsonb_test=row[15], bytea_test=bytes(row[16]), date_test=row[17], time_test=row[18], timetz_test=row[19], timestamp_test=row[20], timestamptz_test=row[21], interval_test=row[22], text_test=row[23], varchar_test=row[24], bpchar_test=row[25], char_test=row[26], citext_test=row[27], uuid_test=row[28], inet_test=str(row[29]), cidr_test=str(row[30]), macaddr_test=row[31], macaddr8_test=row[32], ltree_test=row[33], lquery_test=row[34], ltxtquery_test=row[35])
...
async def get_one_test_timestamp_postgres_type(conn: ConnectionLike, *, id_: int) -> datetime.datetime | None:
    ...
    """
    row = await conn.fetchrow(GET_ONE_TEST_TIMESTAMP_POSTGRES_TYPE, id_)
    if row is None:
        return None
    return row[0]
...
async def update_rows_test_postgres_type(conn: ConnectionLike, *, id_: int) -> int:
    ...
    Returns:
        The number (`int`) of affected rows. This will be 0 for queries like `CREATE TABLE`.
    """
    r = await conn.execute(UPDATE_ROWS_TEST_POSTGRES_TYPE, id_)
    return int(n) if (p := r.split()) and (n := p[-1]).isdigit() else 0
