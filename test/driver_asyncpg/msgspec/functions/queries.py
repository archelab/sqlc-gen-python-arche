...
class QueryResults(typing.Generic[T]):
    ...
    def __init__(
        ...
        *args: QueryResultsArgsType,
        ...
        Arguments:
        conn -- The connection object of type `ConnectionLike` used to execute queries.
...
def get_many_test_bytea_postgres_type(conn: ConnectionLike, *, id_: int) -> QueryResults[bytes]:
    ...
    Returns:
    QueryResults[bytes] -- Helper class that allows both iteration and normal fetching of data from the db.
    """
...
async def get_one_test_bytea_postgres_type(conn: ConnectionLike, *, id_: int) -> bytes | None:
    ...
    Returns:
    bytes -- Result fetched from the db. Will be `None` if not found.
    """
