...
class QueryResults(typing.Generic[T]):
    ...
    def __init__(
        ...
        *args: QueryResultsArgsType,
        ...
        Arguments:
        conn -- The connection object of type `aiosqlite.Connection` used to execute queries.
...
class Queries:
    ...
    def __init__(self, conn: aiosqlite.Connection) -> None:
        ...
        Arguments:
        conn -- Connection object of type `aiosqlite.Connection` used to execute queries.
        """
        self._conn = conn
    ...
    def conn(self) -> aiosqlite.Connection:
        ...
        Returns:
        aiosqlite.Connection -- Connection object used to make queries.
        """
        return self._conn
