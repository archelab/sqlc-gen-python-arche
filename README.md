...
`sqlc.yaml`. Build it from source (see [Development](#development) — the wasm is
never committed, only the source and the pins are), then reference the built
file:
